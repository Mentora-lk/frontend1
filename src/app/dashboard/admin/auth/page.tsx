    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#F8FAF9', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 16px' }}>
        <div style={{ width: '100%', maxWidth: 440 }}>
            ...
            <div style={{ padding: '32px 32px 36px' }}>
              ...
              {activeTab === 'login' && (
                <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                  ...
                  <div style={{ textAlign: 'right', marginTop: -8 }}>
                    <button type="button" style={{ background: 'none', border: 'none', fontSize: 13, color: '#10B981', fontWeight: 600, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" }}>Forgot password?</button>
                  </div>
              ...
              {activeTab === 'signup' && (
                <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 7 }}>Admin Access Code <span style={{ fontWeight: 400, color: '#9CA3AF', marginLeft: 6 }}>(provided by system owner)</span></label>
                    <div className="field-wrap">
                      ...
                      <input type="text" placeholder="MENTORA-XXXX" value={signupForm.adminCode} onChange={(e) => setSignupForm({ ...signupForm, adminCode: e.target.value })} className="auth-input" />
                    </div>
                  </div>
                  <div>
                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: '#374151', marginBottom: 7 }}>Password</label>
          ...
          <p style={{ textAlign: 'center', fontSize: 12, color: '#9CA3AF', marginTop: 20 }}>© 2026 Mentora.lk · Restricted to authorized administrators only</p>
        </div>
      </div>
    </>
  );
